        ...
        <ul className="list-none pl-4">
          {questionList.map((q, index) => (
            <li key={index} className="mb-2 p-4 border rounded shadow-sm bg-white">
              <p className="mb-1"><strong>Question:</strong> {q.question}</p>
              <p className="mb-1"><strong>Prompt:</strong> {q.prompt}</p>
              <p className="mb-1"><strong>Answer:</strong> {q.answer}</p>
              <p className="mb-1"><strong>Marks:</strong> {q.marks}</p>
            </li>
          ))}
        </ul>
      </div>
