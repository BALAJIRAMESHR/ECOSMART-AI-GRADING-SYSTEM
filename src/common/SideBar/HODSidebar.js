...
const Sidebar = () => {
  ...
  const navItems = [
    { path: '/hod', icon: Home, label: 'Home' },
    { path: '/coursemapping', icon: BookOpen, label: 'Course Mapping' },
    { path: '/studentenrollment', icon: GraduationCap, label: 'Student Enrollment' },
    { path: '/qapaper', icon: User, label: 'QA Settings' },
    { path: '/scrutinizer', icon: GraduationCap, label: 'Scrutinizer' }
  ];
